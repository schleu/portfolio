...
import CobolIcon from '../../../../assets/cobolIcon.svg'
import ColdfusionIcon from '../../../../assets/coldfusionIcon.svg'
...
export const HardSkills = [
  ...
  {
    icon: <img src={ColdfusionIcon} className="w-full h-14 duration-700" />,
    text: "Coldfusion",
  ...
  {
    icon: <img src={CobolIcon} className="w-full h-16 duration-700" />,
    text: "Cobol",
