...
export const PROVA_MOCK: Prova = {
  ...
  "questoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção em que o elemento destacado não funciona como adjunto adnominal.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "A felicidade é tão oposta à vida, que estando nela, a gente esquece que vive.\nAssinale a opção correta sobre o sentido da frase em destaque.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção que apresenta corretamente a regência dos verbos.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção que relaciona de modo incorreto o adjetivo à locução adjetiva destacada.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção em que a vírgula se justifica pelo mesmo motivo do que em “se as duas tribos dividirem em paz as batatas do campo, não chegam a nutrir-se suficientemente e morrem de inanição”.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção que indica corretamente a noção semântica expressa pelo elemento destacado em: “A moça recostara-se em uma cadeira de balanço no claro de uma janela, de modo que seu gracioso vulto imergia-se na plena luz”.",
      "opcoes": [
        "Consequência.",
        "Causa.",
        "Finalidade.",
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção em que o verbo destacado indica estado.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Portuguesa",
      "pergunta": "Assinale a opção correta em relação à concordância nominal.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "What information is in TEXT?",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "In the excerpt in TEXT “Recommended by university professors, last-year students, as well as seasoned consultants. Even my mom says you have to read this book, or you have to answer to her!”\nThe pronoun her refers to",
      "opcoes": [
        "consultants.",
        "book.",
        "students.",
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "In the sentence taken from TEXT “The book gives a strong and realistic description of IT consultancy. Thus, every IT student should read the book before they graduate as it will increase their probability of landing a dream job.”\nThe underlined linker introduces",
      "opcoes": [
        "a condition.",
        "an example.",
        "an effect.",
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "“With this book, you can find out why your current job is not satisfying your career aspirations and turn your career around for the better!”\nThe discourse marker and used in TEXT is similar in meaning to",
      "opcoes": [
        "hence.",
        "whereas.",
        "unless.",
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "By the end of TEXT six people assessed the guide. One of them said that he should have had the opportunity to study on the guide on the brick of graduating.\nChoose the person who said that.",
      "opcoes": [
        "Saku Sikiö",
        "Petteri Laamanen",
        "Samuli Pekkola",
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "The pronoun “it” in “It can print up to 20 pages per minute from any PC, Pocket PC, or Windows Mobile handheld”, taken from TEXT, refers to",
      "opcoes": [
        "Computer.",
        "Pocket PC.",
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "In the sentence “No word on pricing or availability, but this is a 1-pound printer we wouldn't mind adding to our travel bag”.\nThe expression “... a 1-pound printer” taken from TEXT is referring to",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "According to TEXT it can be said that",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "In the excerpt “In this work we use AppEco to simulate Apple's iOS app ecosystem and investigate common developer strategies, evaluating them in terms of downloads received, app diversity, and adoption rate.\nChoose the correct option according to TEXT.",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "In the sentences, “With hundreds of thousands of apps in these online stores, what strategy should a developer use to be successful? Should they innovate, make many similar apps, optimize their own apps or just copy the apps of others?”.\nThe modal “should”, used in TEXT, expresses the idea of:",
      "opcoes": [
    ...
    {
      "categoria": "Língua Inglesa",
      "pergunta": "The word “browse” in “user agents browse the store and download the apps.”, taken from TEXT, is a verb.\nThe same word can also be used as a noun in sentence:",
      "opcoes": [
    ...
    },
    {
      ...
      "pergunta": "Arnaldo e Bernaldo associaram-se em um determinado negócio. Arnaldo entrou com R$ 12.000,00 e Bernaldo com R$ 13.000,00. Se perderem R$ 50.000,00, caberá a Arnaldo o prejuízo de",
      "opcoes": [
        "R$ 18.000,00",
        "R$ 20.000,00",
        "R$ 24.000,00",
    ...
    {
      "categoria": "Raciocínio Lógico Matemático",
      "pergunta": "A proposição logicamente equivalente à proposição “Se Cesar é fã de futebol então ele assiste a muitos jogos” é",
      "opcoes": [
    ...
    {
      "categoria": "Raciocínio Lógico Matemático",
      "pergunta": "Numa certa região há alguns vilarejos de maneira que cada dupla de vilarejos possui uma única estrada que os conecta. Observe o exemplo para cinco vilarejos em que cada casinha representa um vilarejo e cada segmento de reta representa uma estrada.\nConsidere que nessa região há inicialmente x vilarejos e que 2 novos vilarejos estejam se desenvolvendo. Por essa razão, 17 novas estradas estão sendo construídas.\nNessas condições, o número x vale",
      "opcoes": [
        "6.",
        "7.",
        "8.",
    ...
    {
      "categoria": "Raciocínio Lógico Matemático",
      "pergunta": "O preço de venda de certo item de consumo sofreu dois aumentos mensais consecutivos, sendo o primeiro de 30% e o segundo de 10%.\nSobre a taxa média de aumento mensal nesse período, é correto afirmar que",
      "opcoes": [
    ...
    {
      "categoria": "Legislação Acerca de Segurança da Informação e Proteção de Dados",
      "pergunta": "A Lei nº 12.527, de 18 de novembro de 2011, dispõe sobre as restrições de acesso à informação. Nesses termos, a lei traz diversos temas que permeiam a classificação da informação.\nSobre esse assunto, é correto afirmar que",
      "opcoes": [
    ...
    {
      "categoria": "Legislação Acerca de Segurança da Informação e Proteção de Dados",
      "pergunta": "A Lei nº 12.965, de 23 de abril de 2014, estabelece princípios, garantias, direitos e deveres para o uso da Internet no Brasil. Ao tratar da proteção aos registros, aos dados pessoais e às comunicações privadas, tal diploma legal positiva sanções específicas para o descumprimento do que prescreve.\nA respeito disso, é correto afirmar que",
      "opcoes": [
    ...
    {
      "categoria": "Legislação Acerca de Segurança da Informação e Proteção de Dados",
      "pergunta": "As sanções administrativas estão positivadas na Lei nº 13.709, de 14 de agosto de 2018 (Lei Geral de Proteção de Dados Pessoais - LGPD), em capítulo intitulado de fiscalização.\nCom relação ao quadro legal sancionatório mencionado, é correto afirmar que",
      "opcoes": [
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "A certificação digital é uma prática amplamente utilizada para garantir a autenticidade e a integridade das comunicações digitais, bem como a identidade das partes envolvidas. Para isso, são empregados diferentes algoritmos criptográficos e métodos de assinatura digital.\nO algoritmo baseado em criptografia assimétrica, utilizado na geração de assinaturas digitais em um sistema de certificação digital é o",
      "opcoes": [
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "De acordo com a Lei Geral de Proteção de Dados Pessoais (LGPD), Lei nº 13.709/2018 e suas alterações, o tratamento de dados pessoais sensíveis só pode ocorrer em determinadas situações específicas.\nO tratamento de dados pessoais sensíveis é injustificado",
      "opcoes": [
        ...
        "para a tutela da saúde, exclusivamente, em procedimento realizado por profissionais de saúde, serviços de saúde ou autoridades sanitárias.",
        "para a proteção do crédito, exclusivamente com o consentimento do titular.",
        "quando necessário para a execução de políticas públicas pela administração pública, previstas em leis ou regulamentos."
      ],
      "resposta": 3
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "O NIST (National Institute of Standards and Technology) Cybersecurity Framework (versão 1.1) é amplamente utilizado como uma referência para fortalecer a segurança cibernética em organizações.\nEstruturado de forma a fornecer um guia adaptável para o gerenciamento de riscos, as funções do componente principal do framework, excluindo a camada de implementação e os perfis, são",
      "opcoes": [
        "Governança, Auditoria, Resposta, Recuperação e Comunicação.",
        "Identificação, Proteção, Detecção, Resposta e Recuperação.",
        "Avaliação de Riscos, Protection de Dados, Conformidade, Resposta a Incidentes e Recuperação.",
        "Planejamento, Proteção, Detecção, Mitigação e Recuperação.",
        "Classificação de Riscos, Proteção de Ativos, Monitoramento, Resposta e Recuperação."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Sobre o gerenciamento de processos e memória em sistemas operacionais, assinale a opção correta.",
      "opcoes": [
        "O escalonamento de processos em sistemas operacionais sempre utiliza algoritmos de preempção.",
        "A memória virtual permite que o sistema operacional execute processos que exigem mais memória do que a disponível fisicamente.",
        "O modelo monolítico de sistemas operacionais é composto por camadas, onde cada camada depende de uma interface externa.",
        "Em sistemas multiprogramados, cada processo ocupa o processador por um tempo indefinido.",
        "O gerenciamento de memória em sistemas operacionais modernos utiliza exclusivamente registradores para acessar a memória física."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em um ambiente de rede corporativa, um administrador de sistemas foi incumbido de configurar um novo servidor usando o Windows Server 2019 para melhorar o desempenho da autenticação de usuários no domínio. O servidor foi configurado como um Controlador de Domínio (Domain Controller) e o serviço de Diretório Ativo (Active Directory Domain Services - AD DS) foi instalado e configurado corretamente. A etapa essencial para configurar um servidor Windows Server 2019 como Controlador de Domínio é",
      "opcoes": [
        "configurar zonas reversas antes de promover o servidor a controlador de domínio.",
        "promover o servidor a controlador de domínio através da ferramenta \"dcpromo.exe\".",
        "executar a função de acionamento de funções e recursos e selecionar o Active Directory Domain Services (AD DS).",
        "desativar obrigatoriamente o firewall do Windows para permitir a correta comunicação com os dispositivos cliente.",
        "configurar necessariamente o servidor como membro de um grupo de trabalho antes de promover a um controlador de domínio."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em relação à administração de sistemas operacionais da família Linux, como Red Hat, Debian e CentOS, o componente responsável por gerenciar o processo de inicialização (boot) do sistema é o",
      "opcoes": [
        "Cron",
        "systemd",
        "init.d",
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em relação aos serviços de diretório, como o Active Directory e o LDAP, assinale a opção correta.",
      "opcoes": [
        "O Active Directory utiliza o protocolo LDAP apenas para autenticação de usuários, enquanto os demais serviços de diretório utilizam protocolos proprietários.",
        "O Active Directory é um serviço de diretório que depende exclusivamente de servidores Unix para funcionar, utilizando a estrutura de arquivos local como repositório de dados.",
        "O LDAP é um protocolo amplamente utilizado em serviços de diretório, e é responsável pela estrutura hierárquica de objetos que permite a organização e a consulta de recursos na rede.",
        "Tanto o Active Directory quanto o LDAP são serviços de diretório com estruturas próprias e independentes, que não podem interagir entre si.",
        "O Active Directory não oferece suporte ao protocolo LDAP, uma vez que utiliza exclusivamente o protocolo Kerberos para todos os seus serviços de autenticação e autorização."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "No contexto de gerenciamento de servidores, aprovisionamento e boas práticas de administração de sistemas, assinale a opção que descreve corretamente o uso de uma ferramenta de gerenciamento de configuração.",
      "opcoes": [
        "Ferramentas de gerenciamento de configuração são projetadas principalmente para realizar backup de dados críticos, evitando a necessidade de configurar regras de rede.",
        "A principal função das ferramentas de gerenciamento de configuração é aplicar atualizações de software, sem interagir com arquivos de configuração do sistema.",
        "Ferramentas de gerenciamento de configuração como Ansible, Puppet e Chef permitem automatizar a configuração de servidores, aplicando regras consistentes em várias máquinas.",
        "O aprovisionamento de servidores por meio de ferramentas de gerenciamento de configuração só é possível em ambientes de cloud computing.",
        "Ferramentas de gerenciamento de configuração não permitem a aplicação de scripts personalizados, limitando-se a executar tarefas predefinidas pelos fabricantes de software."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Sobre os conceitos de contêineres e orquestração de contêineres, assinale a opção que descreve corretamente a função do Kubernetes.",
      "opcoes": [
        "É usado apenas para criar e gerenciar imagens de contêineres em um único host.",
        "Permite a criação de redes virtuais, mas não oferece escalonamento automático.",
        "Automatiza a gestão de contêineres em clusters, incluindo balanceamento de carga e escalonamento.",
        "Kubernetes e Docker são equivalentes em termos de orquestração de contêineres.",
        "Rancher é utilizado exclusivamente para criar imagens de contêineres."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Considere os seguintes trechos de código, um em PowerShell e outro em Shell Script (Bash), que possuem a mesma finalidade:\nAmbos os códigos mostrados realizam a cópia de arquivos com a extensão .txt de uma pasta de origem para uma pasta de backup. Considerando o comportamento esperado de cada script, assinale a opção correta.",
      "opcoes": [
        "O código PowerShell pode gerar um erro se a pasta de backup não existir, enquanto o script Bash irá criar a pasta automaticamente.",
        "O código em PowerShell pode ser executado diretamente no Windows sem necessidade de software adicional, enquanto o código em Bash requer a instalação de um ambiente Unix no Windows.",
        "Ambos os scripts estão incorretos, pois os comandos Copy-Item e cp não realizam cópia recursiva.",
        "O código Bash é mais seguro que o PowerShell, pois impede o sobrescrita de arquivos no destino sem confirmação.",
        "O código PowerShell possui melhor desempenho que o Bash, pois é uma linguagem compilada."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Uma empresa de médio porte está planejando migrar suas operações para a computação em nuvem. A empresa precisa manter controle total de seus dados sensíveis, como informações financeiras e dados de clientes, mas também quer aproveitar a flexibilidade e escalabilidade oferecida por provedores externos para outras funções menos críticas, como desenvolvimento de software.\nO modelo de implantação correto para atender a essas necessidades de segurança e flexibilidade é",
      "opcoes": [
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "A prática de Infrastructure as Code (IaC) tem se tornado cada vez mais comum em ambientes de TI, especialmente em organizações que adotam metodologias ágeis e DevOps. Sobre IaC, assinale a opção que descreve corretamente o seu conceito e características principais.",
      "opcoes": [
        "É uma metodologia que define a automação de processos manuais de infraestrutura por meio de scripts ou arquivos de configuração, permitindo o versionamento e a replicação de ambientes de forma padronizada.",
        "Trata-se de uma abordagem que visa a centralização da infraestrutura em um único datacenter físico, promovendo maior segurança e controle sobre os recursos da organização.",
        "É um modelo de gerenciamento de infraestruturas exclusivamente aplicado a servidores físicos, eliminando a necessidade de automação em ambientes virtuais.",
        "Refere-se à adoção de infraestruturas escaláveis de forma automática, sem a necessidade de arquivos ou scripts de configuração, sendo totalmente gerenciada por inteligência artificial.",
        "É um conjunto de boas práticas que propõe a terceirização completa da infraestrutura de TI, eliminando a necessidade de a empresa gerenciar internamente seus recursos."
      ],
      "resposta": 0
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "No contexto de soluções para gerenciamento de contêineres e virtualização, o software utilizado especificamente para análise de vulnerabilidades de imagens de contêner é o",
      "opcoes": [
        "Red Hat Clair.",
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em uma empresa de médio porte que possui diversas filiais espalhadas por diferentes cidades, o departamento de TI está desenvolvendo um projeto de infraestrutura de rede. O objetivo é garantir a comunicação eficiente entre as filiais, além de manter uma conexão estável entre os computadores e dispositivos dentro de cada unidade. Durante uma reunião, um dos analistas de sistemas sugere que é necessário entender a diferença entre as redes locais (LANs) e as redes de longa distância (WANs) para que se possa escolher a melhor tecnologia de comunicação para cada cenário.\nConsiderando o contexto, assinale a opção correta.",
      "opcoes": [
        "As LANs cobrem áreas extensas, usando satélite e fibra óptica, enquanto as WANs se limitam a pequenos espaços com cabos coaxiais.",
        "As WANs conectam áreas dispersas usando satélite e redes públicas, enquanto as LANs se limitam a pequenas áreas e usam cabos de par trançado ou fibra óptica.",
        "As LANs são mais suscetíveis a interferências, pois usam tecnologias sem fio, enquanto as WANs utilizam cabos blindados e infravermelho.",
        "Tanto WANs quanto LANs utilizam redes sem fio, mas as WANs são mais rápidas que as LANs.",
        "As WANs usam apenas fibras ópticas, enquanto as LANs utilizam principalmente enlaces sem fio para flexibilidade."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em uma rede de computadores, é importante utilizar os dispositivos adequados para garantir a eficiência e a segurança da comunicação.\nO dispositivo de rede que permite a segmentação lógica de uma rede, criando domínios de broadcast independentes, com o objetivo de otimizar o tráfego de rede e aumentar a segurança é o",
      "opcoes": [
        "Hub.",
        "Switch não gerenciável.",
        "Switch gerenciável com suporte a VLAN.",
        "Repetidor.",
        "Roteador."
      ],
      "resposta": 2
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "O modelo OSI é composto por sete camadas, cada uma com funções específicas no processo de comunicação em rede.\nAssinale a opção que descreve corretamente a função da camada de transporte no modelo OSI.",
      "opcoes": [
        "Controla o fluxo de dados entre dispositivos de rede e fornece uma interface de rede para o usuário final.",
        "Realiza o endereçamento lógico e o roteamento dos pacotes de dados entre redes diferentes.",
        "Estabelece, mantém e finaliza conexões de comunicação, além de garantir a confiabilidade da transmissão de dados.",
        "Fornece serviços de tradução e criptografia de dados para garantir a segurança das comunicações.",
        "Gerencia o controle de fluxo e as operações de sincronização, além de especificar o layout físico da rede."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "O SNMP (Simple Network Management Protocol) e o RMON (Remote Monitoring) são protocolos amplamente utilizados em sistemas de gerência de redes. Cada um desses protocolos desempenha um papel específico no monitoramento e gerenciamento de dispositivos de rede.\nCom base nesses conceitos, assinale a opção correta.",
      "opcoes": [
        "O SNMP permite o monitoramento de redes sem a necessidade de agentes nos dispositivos gerenciados, ao contrário do RMON, que exige a instalação de agentes.",
        "O RMON é uma extensão do SNMP, que oferece funcionalidades adicionais de monitoramento, incluindo a coleta de dados de tráfego de rede sem a necessidade de consulta constante ao dispositivo gerenciado.",
        "O SNMP é capaz de monitorar dados históricos de desempenho da rede, enquanto o RMON se limita a dados em tempo real.",
        "O RMON permite a configuração de dispositivos de rede remotamente, enquanto o SNMP é utilizado apenas para monitoramento passivo.",
        "Ambos os protocolos, SNMP e RMON, são utilizados para gerenciar redes, mas o SNMP é mais adequado para pequenas redes, enquanto o RMON se aplica exclusivamente a grandes redes corporativas."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Durante o processo de normalização de um banco de dados relacional, a primeira forma normal (1FN) é um conceito fundamental.\nAssinale a opção que descreve corretamente os critérios da 1FN.",
      "opcoes": [
        "Todos os dados devem ser armazenados em tabelas, sem duplicatas e sem grupos repetidos.",
        "Todos os dados devem ser armazenados em uma única tabela, independente da redundância.",
        "Todas as colunas devem conter apenas valores numéricos e devem ser organizadas em ordem alfabética.",
        "Os dados podem ser armazenados em múltiplas tabelas, desde que haja uma chave primária em cada uma.",
        "Todas as colunas devem conter valores únicos e não nulos, permitindo a existência de grupos repetidos."
      ],
      "resposta": 0
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Durante a implementação de um banco de dados, um desenvolvedor utiliza a Linguagem de Definição de Dados (DDL) para criar uma tabela para armazenar informações sobre clientes. Considere o comando SQL fornecido.\nAssinale a opção correta.",
      "opcoes": [
        "O campo Email pode conter valores duplicados, pois a DDL não impõe restrições de unicidade por padrão.",
        "O comando cria a tabela Clientes com uma coluna ClienteID que não pode ser nula, uma vez que é definida como chave primária.",
        "O campo DataCadastro não será preenchido automaticamente se o usuário não inserir um valor, pois não possui um valor padrão.",
        "A DDL permite a criação de tabelas, mas não pode ser usada para definir restrições de integridade, como chaves primárias ou únicas.",
        "O comando falhará na execução se a tabela Clientes já existir, pois a DDL não permite a substituição de tabelas."
      ],
      "resposta": 1
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Uma empresa de varejo online deseja analisar suas vendas para identificar tendências e oportunidades de melhoria. Para isso, eles implementaram um modelo dimensional de dados, onde as vendas são registradas em uma tabela de fatos, e informações sobre produtos, clientes, tempo e localização são armazenadas em tabelas de dimensão.\nConsiderando o cenário de uma empresa de varejo online que utiliza um modelo dimensional de dados para analisar suas vendas, assinale a opção correta.",
      "opcoes": [
        "As tabelas de fatos armazenam informações descritivas sobre produtos, clientes e tempo.",
        "As dimensões são utilizadas para consolidar dados de diferentes tabelas de fatos.",
        "A modelagem dimensional é aplicável exclusivamente a dados estruturados e numéricos.",
        "As tabelas de dimensão fornecem contexto para as métricas de vendas armazenadas nas tabelas de fatos.",
        "A modelagem dimensional ignora completamente os princípios da normalização de bancos de dados."
      ],
      "resposta": 3
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em um banco de dados relacional, a prática essencial para manter a consistência dos dados e garantir que os relacionamentos entre as tabelas sejam válidos é",
      "opcoes": [
        "utilizar apenas chaves primárias em todas as tabelas, incluindo as tabelas de fatos em um modelo dimensional.",
        "criar relacionamentos entre tabelas sem definir restrições ou regras de integridade.",
        "estabelecer chaves estrangeiras que façam referência a chaves primárias em outras tabelas, assegurando a validade dos dados relacionados.",
        "desativar a funcionalidade de exclusão em cascata ao remover registros, mesmo que isso possa levar a dados inconsistentes.",
        "evitar a aplicação de qualquer tipo de restrição ou regra nas tabelas, permitindo máxima flexibilidade na inserção de dados."
      ],
      "resposta": 2
    },
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "É considerada uma prática fundamental para assegurar o sucesso de um projeto de Business Intelligence (BI) em uma organização",
      "opcoes": [
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Imagine que você está liderando um projeto onde o cliente frequentemente altera suas solicitações e requisitos.\nDe acordo com o Guia PMBOK 7ª Edição, o princípio que garante a estabilidade do projeto, apesar das incertezas, é chamado de",
      "opcoes": [
        "Foco no valor.",
        "Liderar com empatia.",
        "Manter o plano original a todo custo, garantindo que o escopo inicial seja cumprido rigorosamente.",
        "Otimizar a resposta ao risco.",
    ...
    {
      "categoria": "Conhecimentos Específicos",
      "pergunta": "Em 2023, a construção do Telescópio Gigante de Magalhães (GMT) enfrentou desafios devido a divergências entre as partes interessadas sobre os objetivos científicos e o cronograma do projeto, gerando conflitos e atrasos.\nPara resolver essa situação, o gerente de projetos do GMT deveria concentrar seus esforços no",
      "opcoes": [
