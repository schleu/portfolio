...
function App() {
  return (
    <div className="bg-gray-300 w-full flex justify-center relative font-roboto">
      <div className="w-full max-w-[1440px] px-10 py-36 xs:py-24 flex flex-col overflow-y-auto">
        <Header />
        <About />
